...
const Footer = () => {
	return (
		<footer className="w-full h-35 bg-[#1E262B] flex flex-col sm:flex-row justify-between items-center p-8 gap-6">
			...
			<div className="h-full flex flex-col justify-center gap-2 items-center sm:items-start">
				<div className="flex gap-6">
					<a href={"https://twitter.com/David__Goyal"} target="_blank">
						<svg
					...
					<a href={"mailto:goyaldavid1@gmail.com"} target="_blank">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="24"
							height="24"
					...
					<a href={"https://linkedin.com/in/david-goyal"} target="_blank">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="24"
							height="24"
